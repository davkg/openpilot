...
wavfile.write("cruise_step_up.wav", sr, click(2000.0).astype(np.int16))    # brighter pitch -> step up
wavfile.write("cruise_step_down.wav", sr, click(1200.0).astype(np.int16))  # darker pitch  -> step down
