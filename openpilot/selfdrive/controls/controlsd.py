...
class Controls(ControlsExt):
  ...
  def state_control(self):
    ...
    CC.longActive = CC.enabled and (self.CP.openpilotLongitudinalControl or not self.CP_SP.pcmCruiseSpeed) and \
                    (self.longitudinal_active_with_gas or not override_longitudinal)
